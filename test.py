...
parser.add_argument('--volume_path', type=str,
                    default='/content/datasets/Synapse/test_vol_h5_auto',
...
def inference(args, model, test_save_path=None):
    ...
    model.eval()
    metric_list = 0.0
    f = open(r'/content/drive/MyDrive/Deep Learning/SCUNet-plusplus/lists/lists_Synapse/test_output.txt', 'w')
    ...
    # print(metric_list, axis=0)
    # print(metric_list, axis=0)
    print(np.sum(metric_list, axis=0))
